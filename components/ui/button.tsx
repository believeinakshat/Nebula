...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-glow hover:bg-sky-400/90",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-slate-700/80",
        outline:
          "border border-border bg-background/40 hover:bg-slate-900/60 hover:text-foreground",
        ghost:
          "bg-transparent hover:bg-slate-900/80 hover:text-foreground text-muted-foreground",
        destructive:
